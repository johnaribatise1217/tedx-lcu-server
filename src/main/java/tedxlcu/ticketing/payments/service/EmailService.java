...
public class EmailService {
  ...
  public void sendTicketMail(TicketBooking booking) throws Exception {
    ...
    // Generate QR image as byte array
    byte[] qrBytes = generateQRBytes(qrUrl);

    // Add image inline with CID
    String cid = "qrCodeImage"; 
    helper.addInline(cid, new ByteArrayResource(qrBytes), "image/png");

    String imageSection = "<img src='cid:" + cid + "' alt='QR Code' style='width:200px;height:200px;'/>";
  ...
  private byte[] generateQRBytes(String url) throws WriterException, IOException {
